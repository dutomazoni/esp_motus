...
const char* firmwareUrl = "https://api.github.com/repos/dutomazoni/esp_motus/releases/assets/244058708";
const char* firmwareVersionUrl = "https://fancy-locrian-picture.glitch.me/firmware-version.txt";
String currentFirmwareVersion = "v1.0.1";
...
void checkOtaUpdate() {
  if (xSemaphoreTake(httpClientMutex, 0) == pdTRUE) {
    ...
    if (http.begin(client, firmwareVersionUrl)) {
      http.addHeader("Authorization", "token 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");
      ...
      if (httpCode == 200) {
        ...
        if (newVersion != currentFirmwareVersion) {
          ...
          if (binHttp.begin(client, firmwareUrl)) {
